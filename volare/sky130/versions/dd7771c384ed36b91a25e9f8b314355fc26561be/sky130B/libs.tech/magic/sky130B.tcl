#-----------------------------------------------------
# Magic/TCL design kit for SKYWATER sky130B
#-----------------------------------------------------
# Tim Edwards
...
if {[catch {set TECHPATH $env(PDK_ROOT)}]} {
    set TECHPATH /home/donn/.volare/volare/sky130/build/dd7771c384ed36b91a25e9f8b314355fc26561be
}
if [catch {set PDKPATH}] {set PDKPATH ${TECHPATH}/sky130B}
set PDKNAME sky130B
# "sky130" is the namespace used for all devices
set PDKNAMESPACE sky130
puts stdout "Loading sky130B Device Generator Menu ..."
...
# initial layout using the SKYWATER sky130B gencells.
#----------------------------------------------------------------
