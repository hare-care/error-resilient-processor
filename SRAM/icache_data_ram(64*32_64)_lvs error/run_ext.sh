...
gds flatten true
gds ordering true
gds read icache_data_ram.gds
puts "Finished reading gds icache_data_ram.gds"
load icache_data_ram
puts "Finished loading cell icache_data_ram"
