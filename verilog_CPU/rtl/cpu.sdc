...
#set_input_delay -clock clk -max 0.2 [get_ports [list din, start, rstb, wr_ctrl_test_crtl]]
#set_input_delay -clock clk -min -0.2 [get_ports [list din, start, rstb, wr_ctrl_test_crtl]]

# ------------------------- Output constraints ---------------------------------

#set_output_delay -clock clk -max 0.2 [get_ports [list addr_out*]]
#set_output_delay -clock clk -min -0.2 [get_ports [list addr_out*]]
